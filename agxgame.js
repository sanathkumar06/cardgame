...
exports.initGame = function(sio, socket){
    ...
    gameSocket.on('sendchat', sendchat1);
...
function sendchat1(mess) {
    
    io.sockets.in(mess.gameId).emit('updatechat', mess);
}
...
function getWordData(i){
    ...
    var words = Business[random1];

    // Randomize the order of the decoy words and choose the first 5
    var decoys = Target[random2];
    ...
    var wordData = {
        round: i,
        word : words,   // Displayed Word
        answer : decoys, // Correct Answer
